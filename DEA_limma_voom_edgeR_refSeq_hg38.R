...
##################################################################
# make comparision groups and generate figures with different cut-off for sig genes
##################################################################
...
#################################################################
#  limma with VSD normalization and generate figures for different cutoffs for sig genes
#################################################################
...
#########################################
# Heatmap Dendrogram top 1000 part II
#########################################
...
######################
# Export Complete tables with all edgeR results
######################
...
dev.off()
#######################
# generate figure with different cut-off for sig genes and choose threshold 
#######################
#selecting the statistical cutoff
decide <- matrix(c("fdr",0.01, "fdr",0.05,"fdr",0.1,"none",0.01,"none",0.05, "none", 0.1),nrow=6,ncol=2,byr=T)
